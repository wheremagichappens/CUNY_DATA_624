...
\CommentTok{## We convert the 'x' data from a matrix to a data frame }
\CommentTok{## One reason is that this will give the columns names.}
...
\CommentTok{## Look at the data using }
\KeywordTok{featurePlot}\NormalTok{(trainingData}\OperatorTok{$}\NormalTok{x, trainingData}\OperatorTok{$}\NormalTok{y) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## or other methods. }

\CommentTok{## This creates a list with a vector 'y' and a matrix }
\CommentTok{## of predictors 'x'. Also simulate a large test set to }
\CommentTok{## estimate the true error rate with good precision: }
...
\CommentTok{## The function 'postResample' can be used to get the test set performance values}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulated}\OperatorTok{$}\NormalTok{duplicate1 <-}\StringTok{ }\NormalTok{simulated}\OperatorTok{$}\NormalTok{V1 }\OperatorTok{+}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{200}\NormalTok{) }\OperatorTok{*}\StringTok{ }\FloatTok{.1} 
\KeywordTok{cor}\NormalTok{(simulated}\OperatorTok{$}\NormalTok{duplicate1, simulated}\OperatorTok{$}\NormalTok{V1)}
\end{Highlighting}
\end{Shaded}
