...
\NormalTok{Plt_CMP.Scatter <-}\StringTok{ }\NormalTok{CMP_DF.gather }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Variable }\OperatorTok{%in%}\StringTok{ }\NormalTok{CMP.varImp.top5}\OperatorTok{$}\NormalTok{Variable) }\OperatorTok{%>%}\StringTok{ }
