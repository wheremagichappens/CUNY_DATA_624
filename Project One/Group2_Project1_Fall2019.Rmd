...
1. Merge the files and use only 236 observations. 
  ...
  + This would mean making 168 forecasts ($7days x 24hours$) with only 236 data-points prior. 
...
In the end, it made the most sense to model the combined sets in their entireties, so method two was adopted.  
