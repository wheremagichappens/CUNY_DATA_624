...
A forecast for the month of May will be 31 days in length. Finally, we applied a forecast to each series for 31 days, which span across 5 weeks, in May 2010. The numeric forecasts can be viewed in a table output in the appendix section and are also located within our data output folder.   
...
grid.arrange(p1, p2, p3, p4, ncol=2, top=textGrob(label="ATM Forecasts"))
```
...
> @Juliann, commented out the previous write_csv operation and added in another, let's discuss
