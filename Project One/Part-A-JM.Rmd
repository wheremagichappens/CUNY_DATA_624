...
p2<- ggpubr::gghistogram(ATM1_arima$residuals, fill="peachpuff1")+
...
p4<-ggpubr::gghistogram(ATM2_arima$residuals,  fill="lightpink")+
...
p6<-ggpubr::gghistogram(ATM4_arima$residuals,fill="deeppink4")+
...
```{r}
p1<-autoplot(ATM1_arima$fitted)+autolayer(ATM1_fc, color="peachpuff1")+
  coord_cartesian(xlim = c(40, 58))+
  labs(subtitle = "ATM1 Series", x="Weeks", y="Cash")+theme_bw()+theme()
p2<-autoplot(ATM2_arima$fitted)+autolayer(ATM2_fc,  color="lightpink")+
  coord_cartesian(xlim = c(40, 58))+
  labs(subtitle = "ATM2 Series", x="Weeks", y="Cash")+theme_bw()+theme()
p3<-autoplot(ATM4_arima$fitted)+autolayer(ATM4_fc, color="deeppink4")+
  coord_cartesian(xlim = c(40, 58))+
