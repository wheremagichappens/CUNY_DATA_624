...
We used `auto.arima()` on our differenced data to select the best ARIMA model for our series. The following models were selected based on minimizing AIC values:
