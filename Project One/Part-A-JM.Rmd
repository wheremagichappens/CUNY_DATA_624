...
We used `auto.arima()` on our differenced data to select the best ARIMA model for our series. The full models and accuracy statistics can be viewed in the appendix.

*  **ATM1**: ARIMA$(0,0,2)(0,1,1)_7$ 
*  **ATM2**: ARIMA$(2,0,2)(0,1,1)_7$
*  **ATM4**: ARIMA$(0,0,2)(0,1,1)_7$ with errors 
