...
suppressWarnings(source("Part-A-JM.R"))
...
```{r}
urATM1<-cbind("ATM"="ATM1", "Root Test"=round(ATM1_ur@teststat,4),"Diff Root Test" =round(ATM1d_ur@teststat,4))
urATM2<-cbind("ATM"="ATM2", "Root Test"=round(ATM2_ur@teststat,4),"Diff Root Test" =round(ATM2d_ur@teststat,4))
urATM4<-cbind("ATM"="ATM4", "Root Test"=round(ATM4_ur@teststat,4),"Diff Root Test" =round(ATM4d_ur@teststat,4))
...
```{r}
p1<-ggAcf(ATM1d)+ labs(title="diff(ATM1)",x="Lag") +theme_bw()+theme()
p2<- gghistogram(ATM1_arima$residuals, add.normal = T)+
  labs(title="ATM1", subtitle="ARIMA(3,0,2)")+
  theme_bw()+theme()
p3<-ggAcf(ATM2d)+ labs(title="diff(ATM2)",x="Lag") +theme_bw()+theme()
p4<-gghistogram(ATM2_arima$residuals, add.normal = T)+
  labs(title="ATM2", subtitle="ARIMA(1,0,4)")+
  theme_bw()+theme()
p5<-ggAcf(ATM4d)+ labs(title="diff(ATM4)",x="Lag") +theme_bw()+theme()
