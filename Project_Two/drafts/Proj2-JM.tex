...
This project was designed to evaluate a production data set from a
beverage manufacturing company. Our goal is to accurately predict the
Key Performance Indicator (KPI), \texttt{PH}, through predictive
modeling. A score set that consists of 267 cases was also provided and
will be used to score our final model.
